                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($pedido_produto as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/pedido_produto/pedido_produto/' . $item->id) }}" title="View pedido_produto"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/pedido_produto/pedido_produto/' . $item->id . '/edit') }}" title="Edit pedido_produto"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
