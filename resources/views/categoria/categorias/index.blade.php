                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($categorias as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/categoria/categorias/' . $item->id) }}" title="View Categoria"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/categoria/categorias/' . $item->id . '/edit') }}" title="Edit Categoria"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
